...
public class TC02_VerifySortFunctionality extends TC01_VerifyLoginFunctionality{
	...
	public void MethodOfSort() throws IOException {
		...
		ExcelUtilities.write("TestNG", 5, "selected the sorting method successfully");
	}
	...
	public void verifySort() throws IOException {
		...
		ExcelUtilities.write("TestNG", 6, "verified the sort function successfully");
	}
}
